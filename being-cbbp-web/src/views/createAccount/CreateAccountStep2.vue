<template>
  <div class="account-step1">
    ...
    <div class="account-content">
      <p style="color: #3b6088">{{ $t('activate.step2') }}</p>
      <p>{{ $t('activate.create.key') }}</p>
      <p><a-icon class="warning" type="exclamation" />{{ $t('activate.aware.information') }}</p>
      ...
      <a-row style="margin-top: 80px;" v-if="isCreated">
        ...
        <a-col :span="8" align="center">{{ $t('activate.account.create.success') }}</a-col>
        <a-col :span="8" align="center"></a-col>
      </a-row>
      <a-row style="margin-top: 80px;" v-if="isCreated">
        <a-col :span="8" align="center"></a-col>
