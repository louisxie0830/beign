...
class CardFooterView: UITableViewHeaderFooterView {
    ...
    func corner() {
        ...
        bezierPath.addLine(to: CGPoint(x: 0, y: rect.size.height - 5))
        bezierPath.addQuadCurve(to: CGPoint(x: 5, y: rect.size.height), controlPoint: CGPoint(x: 0, y: rect.size.height))
        
        bezierPath.addLine(to: CGPoint(x: width - 5, y: rect.size.height))
        bezierPath.addQuadCurve(to: CGPoint(x: width, y: rect.size.height - 5), controlPoint: CGPoint(x: width, y: rect.size.height))
