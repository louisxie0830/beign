...
CREATE TABLE `blockchain_error_logs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16071 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=137 DEFAULT CHARSET=utf8mb4 COMMENT='高优先级数据';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `open_sync_biz_data_medium` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_subscribe_corp_biz` (`subscribe_id`,`corp_id`,`biz_id`,`biz_type`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='中低优先级数据';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-01-10 10:29:39
